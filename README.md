...
- `service/` — optional, one service: the Private Line, a managed VPS with a name at cec.direct (auto-TLS, your own signaling/STUN/TURN venue, claimed into your fleet as a node), compared against the free shared layer — plus the hand-off to remote help at support.cec.direct. Plain HTML.
